 <template>
    <div class="grid grid-cols-2 white space-y-5">
        <div class="text-black font-bold  my-28 space-y-3">
            <h1 class=" text-6xl">Why Choose Us ?</h1>
            <h2 class="text-pink-500 ml-9 md:text-4xl  font-bold" >mountain shelter pass public steam </h2>
            <h2  class="ml-9 md:text-7xl  font-mono">changing uncle lungs recall principle twice heading is whether ten if stomach goes pencil</h2>
    ...
    <section class="py-6 dark:bg-coolGray-800 dark:text-coolGray-50 bg-gradient-to-r from-pink-400 via-white to-pink-500">
		<div class="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
			<div class="flex flex-col justify-center lg:text-left">
				<p class="mb-1 text-sm font-medium tracking-widest uppercase dark:text-violet-400">the best food on the wolrd</p>
				<h1 class="py-2 text-3xl font-medium leading-tight title-font">Master food </h1>
			</div>
	...
	<footer class="dark:bg-coolGray-800 dark:text-coolGray-50">
		<div class="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-coolGray-400">
			<ul class="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around text-pink-500 text-2xl sm:space-x-4 lg:flex-1 lg:justify-start">
				<li>Shop</li>
				<li>About</li>
				<li>Blog</li>
				<li>Pricing</li>
			...
			<div class="flex flex-col justify-center pt-6 lg:pt-0 text-pink-500">
				<div class="flex justify-center space-x-4">
					<a href="#" title="Instagram" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
					...
					<a href="#" title="Pinterest" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
					...
					<a href="#" title="Twitter" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
					...
					<a href="#" title="Facebook" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
							<path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
						</svg>
					</a>
					<a href="#" title="Gmail" class="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-400 dark:text-coolGray-900">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
